...
export const createEmptyManagerReview = (employeeId: string): ManagerReview => ({
  ...
  corporateDevelopment: [], softManagementSituation: "", strengthsText: "", developmentText: "", categoryRationale: "",
