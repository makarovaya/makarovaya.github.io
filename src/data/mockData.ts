...
export const createEmptyManagerReview = (employeeId: string): ManagerReview => ({
  ...
  agreedFocus: "", developmentTrack: "", targetPosition: "", successorPosition: "", trackComment: "", finalComment: "",
});
